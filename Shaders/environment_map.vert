...
void main() {
	...
	f_positionw = (modelToWorldMatrix * vec4(v_position,1)).xyz; //Posicion del vertice en el mundo
	f_normalw = (modelToWorldMatrix * vec4(v_normal,0)).xyz; //Normal del vertice en el mundo
}
